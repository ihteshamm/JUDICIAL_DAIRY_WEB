...
class Dashboard extends Component {
  constructor(props) {
    super(props);
    this.state = {
      client: global.MyClientReview,
      lawyer: global.MyLawyerReview,
      title: "",
      description: "",
      ratings: "",
      errors: {}
  ...
  render() {
    ...
    >
      <div className="mid container">
        ...
        <h1 style={{color:"white"}} className="display-4 text-center">Add New Review</h1>
              ...
              <div className="row">
                <div className="col-md-8 m-auto">
                  <form noValidate onSubmit={this.onSubmit}>
                    ...
                    <input onClick={this.notify} type="submit" className="btn btn-info btn-block mt-4" />
                  </form>
                </div>
                </div>
              </div>
