            ...
            <div className="row" >
              <div className="card hoverable" style={{ paddingRight: 30, width: "60rem", hover: '', height: '30rem', backgroundColor: 'transparent', fill:'ThreeDShadow'}}>
                <div className="col-md-6 m-auto">
                  <div className="col">
                    <h1 style={{ color: "white" }} className="display-4 text-center">CLIENT LOG IN</h1>
                    <p style={{ color: "white" }} className="lead text-center">Sign in to your account</p>
                    ...
                    <Link to="/register" className="btn btn-info btn-block mt-4">
